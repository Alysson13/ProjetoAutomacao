...
public class BasePage {
	...
	/********* Escrever e Clicar com Wait ************/
	public void escreverWaitId(String id, String texto) {
		WebDriverWait wait = new WebDriverWait(getDriver(), 60);
		wait.until(ExpectedConditions.elementToBeClickable(By.id(id))).sendKeys(texto);
	}
	
	public void navegarWait(String url) {
		WebDriverWait wait = new WebDriverWait(getDriver(), 60);
		wait.until(ExpectedConditions.urlToBe(url));
	}
	
	public void escreverWaitXpath(String xpath, String texto) {
		WebDriverWait wait = new WebDriverWait(getDriver(), 60);
	...
	public void clicarWaitLink(String link) {
		WebDriverWait wait = new WebDriverWait(getDriver(), 60);
		wait.until(ExpectedConditions.elementToBeClickable(By.linkText(link))).click();
	}
	
	public void clicarWaitCss(String css) {
		WebDriverWait wait = new WebDriverWait(getDriver(), 60);
	...
	public void selecionarComboClassName(String classe, String valor) {
	...
	public void selecionarComboBox() {
		WebElement element = getDriver().findElement(By.xpath("/html/body/div[14]/div[2]/select"));
	...
	public void mouseHover(String id, String id2) throws InterruptedException{
		WebElement we = DriverFactory.getDriver().findElement(By.id(id));
		WebElement wd = DriverFactory.getDriver().findElement(By.id(id2));
	...
	public void clicarClassName(String classe) {
		getDriver().findElement(By.className(classe));
	}
	...
	public Object scrollUp() {
		JavascriptExecutor jse = (JavascriptExecutor) getDriver();
		return jse.executeScript("window.scrollBy(0, -250);", "");
	}
	
	public void scrollDownMetade() {
		JavascriptExecutor jse = (JavascriptExecutor) getDriver();
		jse.executeScript("window.scrollBy(0,500)");
	}

	public Object scrollUpMetade() {
		JavascriptExecutor jse = (JavascriptExecutor) getDriver();
		return jse.executeScript("window.scrollBy(0, -500)");
	}
